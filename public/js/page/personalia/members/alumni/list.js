...
$(() => {
    ...
    $('#table-data').on('click', '.btn-update', function () {
        ...
        if (divisi) {
            ...
            $.ajax({
                url: BASE_URL + 'alumni/get-sub-divisi/' + encodeURIComponent(divisi),
                type: 'GET',
                dataType: 'json',
    ...
    $('#divisi').on('change', function () {
        ...
        if (nama) {
            $.ajax({
                url: BASE_URL + 'alumni/get-sub-divisi/' + nama,
                type: 'GET',
                dataType: 'json',
    ...
    $('#update-divisi').on('change', function () {
        ...
        if (nama) {
            $.ajax({
                url: BASE_URL + 'alumni/get-sub-divisi/' + encodeURIComponent(nama),
                type: 'GET',
                dataType: 'json',
                success: function (data) {
                    if (data.length > 0) {

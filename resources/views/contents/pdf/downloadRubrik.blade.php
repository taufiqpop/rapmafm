...
<head>
    ...
    <title>{{ $blueprints->ranah_penilaian }} - Form Rubrik untuk AFEL</title>
</head>

<body style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;">
    <h2 style="text-align: center;">Form Rubrik untuk AFEL {{ $blueprints->ranah_penilaian }}</h2>
    ...
    <div style="margin-top: 30px;">
        ...
        <div style="margin-top: 30px;">
            ...
            <div>
                ...
                <textarea style="width: 100%; height: auto; font-family: 'Times New Roman', Times, serif; padding: 10px;">{{ $blueprints->kriteria_penilaian }}</textarea>
            </div>

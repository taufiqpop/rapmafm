...
@section('contents')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if (rbacCheck('dana_universitas', 2))
                        <div class="row mb-2">
                            <div class="col-sm-12">
    ...
    {{-- Create --}}
    <div id="modal-dana-universitas" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modal-dana-universitasLabel" aria-hidden="true">
        <form action="{{ route('dana-universitas.store') }}" method="post" id="form-dana-universitas" autocomplete="off">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="modal-dana-universitasLabel">Form Arus Kas</h5>
    ...
    {{-- Update --}}
    <div id="modal-dana-universitas-update" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modal-dana-universitas-updateLabel" aria-hidden="true">
        <form action="{{ route('dana-universitas.update') }}" method="post" id="form-dana-universitas-update"
            autocomplete="off">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="modal-dana-universitas-updateLabel">Form Arus Kas</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@push('scripts')
    <script src="{{ asset('js/page/gmpa/dana-universitas/list.js?q=' . Str::random(5)) }}"></script>
@endpush
